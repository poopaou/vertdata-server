...
public final class Jsons {
     ...
     */
    public static JsonArray getDiff(@Nonnull JsonObject source, @Nonnull JsonObject target){
    ...
    public static JsonObject lazyGetJsonObject(@Nonnull JsonObject from, @Nonnull String name){
        Objects.requireNonNull(from, "missing json object");
        Objects.requireNonNull(name, "missing property name");
        JsonObject object = from.getJsonObject(name);
        if (object == null){
            object = new JsonObject();
            from.put(name, object);
        }
        return object;
    }

    public static JsonArray lazyGetJsonArray(@Nonnull JsonObject from, @Nonnull String name){
        Objects.requireNonNull(from, "missing json object");
        Objects.requireNonNull(name, "missing property name");
        JsonArray object = from.getJsonArray(name);
        if (object == null){
    ...
    public static JsonObject newJsonObject(String name, Object value){
        return newJsonObject().put(name, value);
    }
}
